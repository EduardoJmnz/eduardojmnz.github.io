...
<head>
  ...
  <style>
    :root{
      ...
      /* ✅ Preview adaptativo: desktop lo setea JS */
      --previewZoom: 0.75;
    ...
    *{ box-sizing:border-box; }
    ...
    #app{
      ...
      grid-template-columns: 1fr var(--editorW);
      grid-template-areas:
        "header header"
        "preview editor";
    }
    ...
    .topbar{
      ...
      background: linear-gradient(180deg, rgba(15,18,26,.85), rgba(12,15,21,.65));
    ...
    .dot{
      width:12px;height:12px;border-radius:999px;background: var(--accentSolid);
    ...
    /* ✅ Preview: sin scroll en desktop (debe encajar) */
    .previewArea{
      grid-area: preview;
      position:relative;
      overflow:hidden;
    ...
    /* ✅ “sombra blanca tenue” alrededor del preview */
    .previewStage{
      position: relative;
      width: calc(var(--posterW) * var(--previewZoom));
      height: calc(var(--posterH) * var(--previewZoom));
      overflow: hidden;
      ...
      box-shadow:
        ...
        0 18px 80px rgba(255,255,255,.06);
    }
    ...
    .previewScale{
      ...
      transform: scale(var(--previewZoom));
    }
    ...
    .bottomText{
      ...
      bottom: calc(var(--posterPad) + var(--bottomTextBottom));
      padding:0;
    }
    ...
    .poster.rectStyle .tTitle{
      font-size: 46px;
      margin-bottom: 8px;
      letter-spacing: 1.4px;
    }
    .poster.rectStyle .tSub{
      font-size: 16px;
      margin-bottom: 16px;
    }
    .poster.rectStyle .meta{
      justify-content:center;
      font-size: 12px;
      gap: 16px;
    }
    .poster.rectStyle .metaCol{ align-items:center; text-align:center; }
    ...
    .sheet{
      ...
      border-radius: 22px;
      background: linear-gradient(180deg, rgba(15,18,26,.92), rgba(12,15,21,.86));
    ...
    /* ✅ más espacio entre texto y barra */
    .sheetTab{
    ...
    .sheetTab.active::after{
      ...
      border-radius: 999px;
      box-shadow: 0 0 16px rgba(124,255,250,.20);
    }
    ...
    /* ✅ FIELD CARD (igual al screenshot) */
    .fieldCard{
    ...
    /* ✅ input dentro del card como en la imagen */
    .fieldInput{
      width:100%;
      border:1px solid rgba(233,238,252,.10);
    ...
    .styleTile.active .stylePoster{
      ...
      box-shadow: 0 0 0 2px rgba(255,210,90,.25), 0 10px 24px rgba(0,0,0,.28);
    }
    ...
    .swatchTile.active .swatchDot{
      border-color: rgba(255,210,90,.95);
      box-shadow: 0 0 0 2px rgba(255,210,90,.25), 0 8px 18px rgba(0,0,0,.22);
    }
    .swatchName{
      font-size: 11px;
      font-weight: 800;
    ...
    @media (max-width: 980px){
      ...
      #app{
        ...
        grid-template-rows: var(--headerH) auto auto;
        grid-template-areas:
          "header"
          "preview"
          "editor";
      ...
      .sheetTabs{ padding: 12px 12px 10px 12px; }
      .sheetTab{ font-size: 13px; padding: 10px 0 18px 0; }
      .sheetTab.active::after{ height: 4px; }
...
<body>
  <div id="app">
    <header class="topbar">
      <div class="brand">
        ...
        <div class="brandText">
          ...
          <div class="brandSub">v2.100126.finalUI</div>
        </div>
      </div>
      <div class="topbarRight">© wolffel 2026</div>
    </header>

    <main class="previewArea noScrollBar" id="previewArea">
    ...
    <aside class="editorDock">
      <div class="sheet">
        <div class="sheetTabs" id="tabs"></div>
        <div class="sheetBody noScrollBar">
          <div class="card" id="sectionContainer"></div>
        </div>
      </div>
    </aside>
  </div>
