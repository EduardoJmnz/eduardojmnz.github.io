(() => {
  ...
  // Backend API base (configurable en frontend/public/config.js)
  const API_BASE = (window.SKymapConfig && window.SKymapConfig.apiBase) ? String(window.SKymapConfig.apiBase).replace(/\/$/, "") : "";
